...
/* 
   ...
   <body>
      ...
      <form method="POST" action="${pageContext.request.contextPath}/createProduct" enctype="multipart/form-data">
         ...
         <label>Name</label>
         <input type="text" name="name" style="width:50%;padding:10px;margin:10px"/>
         <br/>
          <label>Price</label>
         <input type="text" name="price" style="width:50%;padding:10px;margin:20px"/>
         <br/>
         <label>Image</label>
	    ...
	    <script type="text/javascript">
         ...
         <input type="text" name="note" style="width:50%;padding:10px;margin:10px"/>
         <br/>
