    ...
    <div class="w3-main" style="margin-top:43px;">
        <div class="khung">
			...
			<script>
           	...
           	<a href="deleteCategory?categoryId=${category.categoryId}" onclick="return ConfirmDelete();" class="w3-button w3-green w3-margin-bottom" style="text-decoration: none;border-radius:5px">
            ...
            <form method="POST" action="${pageContext.request.contextPath}/editCategory">
            	<div class="row">
                    ...
                    <div class="col-75">
                        <input type="text" name="categoryId" value="${category.categoryId}" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                    	<c:choose>
							<c:when test="${category.subid.equals('2')}">
						    	<select name="subid">
		                    		<option value="2" selected>Nam</option>
		                    		<option value="1">Nữ</option>
		                    	</select>
							</c:when>
							<c:when test="${category.subid.equals('1')}">
						    	<select name="subid">
