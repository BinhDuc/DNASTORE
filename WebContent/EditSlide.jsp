...
<body>
    ...
    <div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
       	<a href="${pageContext.request.contextPath}/carousel" class="w3-bar-item header"><i class="fas fa-arrow-left"></i></a>
    ...
    <div class="w3-main" style="margin-top:43px;">
        <div class="khung">
				...
				<c:when test="${Message.equals('Sửa thành công')}">
					<script>
					    $(document).ready(function(){
					        swal('Thành Công!', 'Carousel đã sửa thành công!', 'success');
					    });
					</script>
				</c:when>
			    <c:otherwise>
            ...
            <div>
                <h2 style="font-family: AvertaStdCY-Semibold;">Sửa Carousel</h2>
            </div>
			<script>
           	...
           	<a href="deleteSlide?id=${slide.id}" onclick="return ConfirmDelete();" class="w3-button w3-green w3-margin-bottom" style="text-decoration: none;border-radius:5px">
           		Delete <i class="fas fa-trash-alt"></i>
           	</a>
            <form method="POST" action="${pageContext.request.contextPath}/editSlide" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="text" name="slidename" value='${slide.slideName}'>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                ...
                <div class="row">
                    ...
                    <div class="image">
                            <div class="image-boder">
                                <img id="image_upload_preview" src="${pageContext.request.contextPath}/bgSlide?id=${slide.id}" alt="your image" class="responsive"/> 
                            </div>
                    </div>
                        <input type='file' id="inputFile" name="background" required/>    
                    </div>
                </div>
                <br>
                <div class="row">
